...
export default class AllChannels extends React.Component {
  ...
  render() {
    ...
    return (
      <View
        style={{ flex: 1, alignItems: "center", backgroundColor: "#ADDDCE" }}
      >
        <Text style={{ alignSelf: "stretch", margin: 5, padding: 5 }}>
          {loggedUser.name} - Subscribed Channels
        </Text>
  ...
  componentDidUpdate() {
    ...
    const updatedUser = {
      ...restOfUser,
      subscribed_channels: JSON.stringify(subscribedChannels)
    };
